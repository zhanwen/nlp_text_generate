...
from train_self import optimization_adafactor
from train_self.utils import get_assignment_map_from_checkpoint, get_shape_list, get_attention_mask, gelu, layer_norm, dropout, \
...
class GroverConfig(object):
    ...
    def from_json_file(cls, json_file):
        ...
        with tf.gfile.GFile(json_file, "r") as reader:
            # text = reader.read()
            print("  ")
        text = '{"vocab_size": 8021,"hidden_size": 1536,"attention_probs_dropout_prob": 0.1,' \
               '"hidden_dropout_prob": 0.1,"hidden_act": "gelu","initializer_range": 0.014142135623731,' \
               '"intermediate_size": 6144,"max_position_embeddings": 1024,"num_attention_heads": 24,"num_hidden_layers": 48}'
